...
function openModalPalmeiras(){
    ...
    close_button_link.innerHTML = "<i class='modal__close modal__overlay-close--form icon icon-close'>";

    relative_element_modal.appendChild(div_modal);
    modal_overlay.appendChild(relative_element_modal);
    micromodal_slide.appendChild(modal_overlay);

    let divVideoPalmeiras = document.createElement("div");
    divVideoPalmeiras.classList.add("hino-palmeiras");
    divVideoPalmeiras.style.display = "none";
    divVideoPalmeiras.innerHTML = hinoPalmeiras;
